    ...
    <div id="app">
        <nav class="navbar navbar-expand-lg sticky-top" style="min-height: 76px; background-color: #F8EDE3;">
            <div class="container">
                ...
                @else <link rel="icon" type="image/x-icon"
...
href="{{ $set->logo == null ? asset('app-assets/icon/store.png') : asset('storage/setting_images') . $set->logo }}">
                ...
                <div class="collapse navbar-collapse w-100" id="navbarText">
                    <ul class="navbar-nav ms-md-auto mb-2 mb-lg-0 ">
                        <li class="nav-item">
                            <a class="nav-link text-black" href="/landing">Zulla Cell</a>
                        </li>
                        <li class="nav-item">
                       ...
                       <!-- Start Atribute Navigation -->
                        ...
                        <li class="nav-item dropdown text-black">
                            ...
                            @guest
                                    ...
                                    <a class="dropdown-item  text-black" href="/login">Login</a>
                         

                      
                            
                                    <a class="dropdown-item  text-black" href="/register">Register</a>
                               
                     
                            @else
                                @if(auth()->user()->is_admin == 1)
                           
                                    <a class="dropdown-item  text-black" href="{{ route('admin.home') }}">{{ __('Admin Panel') }}</a>

...
<br>
    <div class="container">
        <div class="mb-4" style="position: relative">
            <div class="card" style="background: #ABAC84">
                <div class="card-body p-5">
                    <h3 class="text-center mb-3 fw-bold">Cari Handphone Favoritmu!</h3>
        ...
        @if ($search)
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    ...
                    <a href="/phone" class="btn btn-secondary px-2">Kembali</a>
                </div>
                    ...
                    @if (count($phone) > 0)
                        @foreach ($phone as $d)
                            <div class="card me-4 mb-4" style="width: 250px;">
                                <div class="card-body">
                                    @if ($d->thumbnail !== null)
                                        <img src="{{ asset('storage/handphone_images/thumbnail') . $d->thumbnail }}"
                                            class="rounded img-fluid mb-2" alt=""
                                            style="min-height: 153px; max-width: 213px backgroun: grey"
                                            alt="{{ $d->name }}">
                                    @else
                                        <img src="handphone_images/default.png" class="rounded img-fluid mb-2" alt=""
                                            style="min-height: 153px; max-width: 213px backgroun: grey"
                                            alt="{{ $d->name }}">
                                    @endif
        ...
        @else
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    <h5 class="fw-bold align-self-center">Handphone</h5>
                </div>
                <hr class="border-main">
                <div class="d-flex flex-wrap">
                    @foreach ($phone as $d)

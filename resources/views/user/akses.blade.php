...
<br>
    <div class="container">
        <div class="mb-4" style="position: relative">
            <div class="card" style="background: #ABAC84">
                <div class="card-body p-5">
                    <h3 class="text-center mb-3 fw-bold">Cari Aksesoris Favoritmu!</h3>
                    <form class="d-flex" role="search">
                        <input class="form-control me-2" type="search" placeholder="Aksesoris..." aria-label="Search"
                            name="search">
        ...
        @if ($search)
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    ...
                    <a href="/akses" class="btn btn-secondary px-2">Kembali</a>
                </div>
                    ...
                    @if (count($akses) > 0)
                        @foreach ($akses as $d)
                            <div class="card me-4 mb-4" style="width: 250px;">
                                <div class="card-body">
                                    @if ($d->thumbnail !== null)
                                        <img src="{{ asset('storage/aksesori_images/thumbnail') . $d->thumbnail }}"
                                            class="rounded img-fluid mb-2" alt=""
                                            style="min-height: 153px; max-width: 213px backgroun: grey"
                                            alt="{{ $d->name }}">
                                    @else
                                        <img src="aksesori_images/default.png" class="rounded img-fluid mb-2" alt=""
                                            style="min-height: 153px; max-width: 213px backgroun: grey"
                                            alt="{{ $d->name }}">
                                    @endif
                        ...
                        @endforeach
                    @else
                        <p class="my-5 text-center fw-semibold text-center w-100">Opps! tidak ditemukan</p>
                    @endif
        ...
        @else
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    <h5 class="fw-bold align-self-center">Aksesoris</h5>
                </div>
                <hr class="border-main">
                <div class="d-flex flex-wrap">
                    @foreach ($akses as $d)

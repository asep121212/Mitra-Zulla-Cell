...
<br>
    <div class="container">
        ...
        @if ($search)
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    ...
                    <a href="/pulsa" class="btn btn-secondary px-2">Kembali</a>
                </div>
                ...
                <div class="d-flex flex-wrap">
                    @if (count($pulsa) > 0)
                        ...
                        @endforeach
                    @else
                        <p class="my-5 text-center fw-semibold text-center w-100">Opps! Kategori Pulsa tidak ditemukan</p>
                    @endif
        ...
        @else
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    <h5 class="fw-bold align-self-center">Three</h5>
                </div>
                <hr class="border-main">
                <div class="d-flex flex-wrap">
                    @foreach ($pulsa as $d)
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    <h5 class="fw-bold align-self-center">Telkomsel</h5>
                </div>
                <hr class="border-main">
                <div class="d-flex flex-wrap">
                    @foreach ($pulsa as $d)
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    <h5 class="fw-bold align-self-center">Axis</h5>
                </div>
                <hr class="border-main">
                <div class="d-flex flex-wrap">
                    @foreach ($pulsa as $d)
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    <h5 class="fw-bold align-self-center">Indosat</h5>
                </div>
                <hr class="border-main">
                <div class="d-flex flex-wrap">
                    @foreach ($pulsa as $d)
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between w-100">
                    <h5 class="fw-bold align-self-center">Smartfren</h5>
                </div>
                <hr class="border-main">
                <div class="d-flex flex-wrap">
                    @foreach ($pulsa as $d)

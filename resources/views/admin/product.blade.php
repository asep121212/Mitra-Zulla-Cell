            ...
            <table id="dataTable" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{
                            ($product->raw == 0) ? 'Price' : ' BestSeller/ Normal'
                            }}</td>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="mb-3">
                                <label for="product_status" class="form-label">Jenis</label>
                                <select id="product_status" class="form-select" name="product_raw"
                                    aria-label="Default select example">
                                    <option value="4" {{ ($product->raw == 4) ? 'selected' : '' }}>Smartfren
                                    </option>
                                    <option value="3" {{ ($product->raw == 3) ? 'selected' : '' }}>Indosat
                                    </option>
                                    <option value="2" {{ ($product->raw == 2) ? 'selected' : '' }}>Tri 
                                    </option>
                                    <option value="1" {{ ($product->raw == 1) ? 'selected' : '' }}>Telkomsel 
                                    </option>
                                    <option value="0" {{ ($product->raw == 0) ? 'selected' : '' }}>Tri</option>
                                </select>
                            </div>
                            <div class="mb-3">
